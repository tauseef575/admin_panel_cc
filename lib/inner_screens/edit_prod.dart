...
import 'package:admin_panel_cc/controllers/MenuController.dart';
import 'package:admin_panel_cc/services/global_method.dart';
...
class EditProductScreen extends StatefulWidget {
  const EditProductScreen(
      ...
      required this.isPound,
      required this.desc})
      : super(key: key);

  final String id, title, desc, price, productCat, imageUrl;
  final bool isPound, isOnSale;
